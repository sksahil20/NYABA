...
public class Front_Scan extends AppCompatActivity {
    ...
    private void goToScannedCopy() {
        Intent frontIntent=new Intent(Front_Scan.this,scanned_copy.class);
        frontIntent.putExtra("frontScan", currentPhotoPath);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.topstack.nyaba.fileprovider",
                        photoFile);
